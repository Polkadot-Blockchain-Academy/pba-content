...
<li class="fragment">To select among multiple equilibria, the notion of a <span style="font-style: italic;">Schelling Point</span> is sometimes invoked.</li>
</ul>
...
- Three different group sizes: 15, 25 and 35 students.
