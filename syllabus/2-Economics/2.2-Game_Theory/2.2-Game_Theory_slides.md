...
1. **[Quiz](#quiz)**
1. [Types of Games](#types-of-games)
1. [Public Goods and the Tragedy of the Commons](#public-good-game)
...
- Modern game theory is used beyond economics, but also in biology, sociology, political science, psychology, among others.
...
A fundamental problem in certain strategic interactions:
...
<!-- TODO DESIGN Replace above table img, related to the next one -->
...
<!-- TODO DESIGN Replace above table img, related to the last one (highlighted) -->
...
<!-- TODO DESIGN Replace above table (see how it looks here: https://paritytech.github.io/polkadot-blockchain-academy/syllabus/2-Economics/2.2-Game_Theory/2.2-Game_Theory_slides.html#/28) -->
...
<widget-image src="/assets/img/2-Economics/2.2-sweden-1967.jpg"></widget-image>
...
<center>
<widget-image style="width: 80vw;" src="/assets/img/2-Economics/2.2-pgg-instructions.png"></widget-image>
</center>
