...
<widget-speaker small name="Jonas Gehrlein" position="Research Scientist at Web3 Foundation" image="/assets/img/0-Shared/people/jonas.jpg"></widget-speaker>

---

<widget-speaker name="Jonas Gehrlein" position="Research Scientist at Web3 Foundation" image="/assets/img/0-Shared/people/jonas.jpg" github="jonasW3F" twitter="GehrleinJonas" linkedin="jonas-gehrlein" matrix="jonas:web3.foundation"></widget-speaker>
...
| ---------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Definition       | Preferences of the players are common knowledge.                             | Preferences are not common knowledge.                                                                |
| Simple Example   | Tic-Tac-Toe. Both players prefer winning over losing.                        | TBD.                                                                                                 |
...
- Real-life examples:
  - NATO and Russia in their arms race: Both prefer no arms race to an arms race. Yet, having some arms is preferable to having no arms, irrespective whether to other one is armed.
...
- A prominent one is the theory of so-called _Schelling points_.
...
### Discussion: Why are economic equilibria are important?

> Why is having a unique Nash equilibrium or a Schelling point important for us?
...
- there _should_ be fishing/production/mining! After all there are always benefits to these activities.
...
\begin{align}
k*1^* &= \frac{1}{2}[K-k_2^_] \\
k*2^* &= \frac{1}{2}[K-k_1^_]
\end{align}
...
\begin{align}
u*1(k_1^*,k*2^*) &= \ln(K/3)+\ln(K/3) = \ln(K^2/9) \\
