...
> Jack and Angela are rivals and keep taunting each other in front of others. At one time, Jack challenges Angela to a game of chicken. He proposes that both Jack and Angela get in their cars and drive towards each other on a road. In the middle of the distance between each other, there is a small bridge with a single line. Whoever swerves away before the bridge *chickened out*. If both keep straight, there is no way to avoid a strong collusion between the two cars.
...
- Which additional freerider problem was in the game?
- What is the endgame effect?
