...
# Lesson 2 -- Game Theory Basics (60 min) [REVISION]
...
# Workshop: Games (70 min)

---

TODO: Remove this slide because it only gives infos for reviewer.
...
## P-beauty contest
* The classroom will be divided into 3 groups. 
* You can win a prize for correctly guessing 2/3 of the average guess.
...
* You play a Prisoner's Dilemma over 10 rounds.
* The payouts are accumulated over the rounds.
