...
- In this lecture, we will talk about the power of incentives.
...
- **Understanding:**
  ...
  - **Security:** Testing economic security of protocols to various types of attacks.
...
Basic idea: in case of multiple equilibria, **social norms may help to choose one.** <!-- .element: class="fragment" -->
...
## Modelling a PG as interactive game

- All players have some endowment, e.g., 10 US Dollars.
- Each player can choose how much to contribute (between 0 and 10) to the public good.
- The consumption value of the public good is some factor (let's call it $\alpha$) times the sum of all other contributions.
