...
In interrogation They both are offered the following: <!-- .element: class="fragment" -->
...
- Driving on the right/left side of the road. <!-- .element: class="fragment" -->
- Money adoption. <!-- .element: class="fragment" -->
- Standard adoption. <!-- .element: class="fragment" -->
...
<center>
<widget-image style="width: 30vw;" src="/assets/img/2-Economics/2.2-sweden-1967.jpg"></widget-image> <!-- .element: class="fragment" -->

Sweden, 1967. <!-- .element: class="fragment" -->
