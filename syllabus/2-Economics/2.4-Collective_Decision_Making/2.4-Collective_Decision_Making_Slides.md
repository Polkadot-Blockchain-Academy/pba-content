...
- This lecture will be markedly less "exact" than the previous ones in the module. It will be less math and more critical thinking. 
- Hence, I encourage class participation.
- However, many topics may be contentious and we might not be able to agree, especially not within the lecture time. The objective of the lecture is to awaken your curiosity on the topic, and I encourage you to continue the discussions outside the classroom.
- In the second half of the lecture we'll talk about voting mechanisms, which are widely used within many decision making systems.
...
- A prerequisite for the formation of countries,
  companies, dynasties, i.e., _strong institutions_.
- Agile decision making helps collective react to
  _external_ changes: war, trade, migration.
- _Internally_, they enable stability and progress: 
money, laws, private property.

---

## Why?

- Even high tech, higly automated projects 
remain human collectives at their core.
- A project's decision-making mechanisms 
ensure its strength and relevance over time.
- We should consider these mechanisms 
along with the project's economics and security.
...
- While _utility_ is about the objective quality of the final result, _legitimacy_ is about the perceived quality of the process. A mechanism is considered legitimate if most people trust the process, agree with it and feel empowered by it, even if they may not personally like the outcome. 
...
- This is the type of questions we are gonna explore in this lecture.    
...
- May or may not provide stability.
...
- We saw that direct democracy is legitimate but not practical. How does it fare in terms of utility? Relatively well, but we argue here that it is not ideal, due to somethig called the voting paradox.
...
- When the number of voters is in the millions, the likelihood that my vote actually changes the outcome is tiny, well below $0.1\%$. My *expected profit* for voting is then 
(my profit for B - myr profit for A)$\times$prob. that my vote flips the result.
...
**Voting paradox:** For a rational, self-interested voter, 
voting costs will normally exceed the expected benefits.
    
Minimal chance that single vote changes collective decision, 
so most of the time the individual voting benefit is zero.

A _common good_ game: globally optimal if everyone votes, 
but personally optimal not to vote.
...
- A notion related to the voting paradox is that of rational ignorace: when the expected benefit we obtain from voting is minimal, we might not vote judiciously, even when we vote. 
- We have limited time and limited capacity to learn things, so we will give prefence to acquiring the knowledge that personally brings us the most expected potential benefit. 
...
while 60% rejects it. However, a company 
...
- Another consequence of rational ignorance is that someone's vote can be biasable. If you don't have a strong opinion about a vote because you haven't spent the time to learn about the issue deeply, you're more likely to be easily influenciable.
...
- This leads to low turnout, which raises the question of legimitacy if a majority of the population does not voice their opinion.
...
- Although a dictatorshis is obviously a captured system, other systems also have varying degrees of risk of being captured. 
...
- Without a doubt, one of the most desirable criteria for a collective decision making mechanism is _simplicity_, meaning that it should be easy to understand and participate for the population.   This is probably a big pro for voting mechanisms.
...
- Recall that voters only vote for a single voter per round. But for convenience in what follows we assume we know the full candidate ranking of each voter, so we can analize what would happen if any two out of the three candidates go head to head in the second round.
...
![](https://i.imgur.com/w8nJ8o1.png)

Source: https://indianexpress.com/article/political-pulse/the-10-other-sahus-how-namesakes-almost-cost-bjps-chandu-lal-sahu-a-win/

Notes: 

- Which of these mechanisms is better? Here is an argument against plurity voting.
...
- This issue is known as _vote splitting_. Two-round voting helps reduces its effect.
...
- Monotonicity is one of the most intuitive criteria that we would expect from a voting rule.
  It says that the winning candidate should be stable relative to monotonic changes of the voter's preferences. In particular, if a voter raises their preference for the current winner, or lowers their preference for other candidates, then the winner should not change.
...
- Indeed, in the previous example, the bottom-row voters want candidate A to win, but are better off marking C as ther top preference.
...
The president changes the voting mechanism so that in each referendum, only 5% of the population elected uniformly at random is _allowed_ to vote. As a result, every person is allowed to participate in one out of 20 referendums on average.
...
Many blockchain networks run elections to select a committee of _validators_: participants of consensus. 

A blockchain network may elect a committee of validators to participate in 
