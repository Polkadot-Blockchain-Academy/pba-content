...
If a collective can be identified as "how it decides to use its resources, privilege or authority", then we can define it formally as this decision-making mechanism.
