...
- Valuations are _sampled uniformly at random from $[0,1]$_.
- Valuations are independent from one another.
...
_Nash equilibrium:_ A set of strategies, one per player,
...
- This is something important to remember. If you want to maximize the auctioneer's revenue and don't mind playing psychological games with the bidders, you should choose first price auctions over second price auctions.
...
he waits for first bidder to signal accepting the price, and Fred makes the signal first.
He's guaranteed to win with least possible price.

In second-price auction, if Fred is auctioneer
he can shill bid successfully: when a highest bid arrives, he creates bid slightly under it and makes it appear as if it was created first.
