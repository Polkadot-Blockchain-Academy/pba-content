...
- Most commonly, we refer to economic incentives.
- These fall under the umbrella of extrinsic incentives.

---

## Different Types of Economic Incentives
- In a workplace setting, employees are often motivated by various forms of economic incentives, including:
...
Note: In a rational framework, all considerations can be translated into monetary terms.

---

## Unintended Consequences: When Incentives Backfire
- There are instances where incentives might not work as intended.
  - Bounty on Cobras in Colonial India.
  - A small fine for parents in Haifa for getting their kids late from daycare.
...
-->  Extrinsic motivation can destroy intrinsic motivation.  
...
- Incentives are the fundament of human (and computer) interaction in society.
- It is imperative to construct incentinves properly.
- Especially in social interactions, not all incentives are monetary.
