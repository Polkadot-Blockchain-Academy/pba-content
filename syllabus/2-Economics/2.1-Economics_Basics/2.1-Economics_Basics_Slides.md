...
- Provides assurances about the conduct of machines- Objective
- Objective in nature
- Promotes deterministic actions
- Serves as a toolbox dictating secure operations by computers.
...
- Acts as a toolbox illustrating the actions humans are likely to undertake.
...
<pba-flex center>
<ul>
<li class="fragment">While non-monetary incentives are essential in human interactions, the digital age has introduced new actors in our economic systems.</li>
...
- Exception are "Veblen goods" where demand increases when price increases.
  These are typically luxury goods that signal something (e.g. status, reputation) in addition to being useful to consumption. Examples are jewelry, luxury cars, etc.
...
<ul>
    <li class="fragment">If both Alice and Bob focus on their comparative advantage, then total welfare is higher than in a situation of autarky!</li>
    <li class="fragment">Why?
        <ul>
            ...
            <li class="fragment">Situation B - Trade: Alice produces focuses most of her time to produce meat and some to produce potatoes, while Bob focuses only on producing potatoes.</li>
...
- Autarky: 
    - Alice: 4hrs * 10 meat, 4hrs * 20 potatoes = 40 meat, 80 potatoes
    - Bob: 4hrs * 2 meat, 4hrs * 10 potatoes = 8 meat, 40 potatoes
- Trade:
    - Alice: 5hrs * 10 meat, 3hrs * 20 potatoes = 50 meat, 60 potatoes
    - Bob: 0hrs * 2 meat, 8hrs * 10 potatoes = 0 meat, 80 potatoes
...
- What does that tell us about daily life?
    - It's often good to stick things where you have a comparative advantage: For example, assume you are a great software engineer with a job that has a high salary, but you also want to help clean up the ocean. Instead of giving up your job and go clean the ocean, you might want to allocate some of your salary to ocean cleanup, having a larger effect.
    - Only because one co-worker has a total advantage in two dimensions of the job, another co worker can still have the comparative advantage in one of the tasks.
...
<img src="../../../assets/img/2-Economics/2.1-oceangate.png" alt="OceanGate Titan" style="width:600px;" class="fragment" />
</span>
...
<span style="display:flex; justify-content:center; align-items:center;">
<img src="../../../assets/img/2-Economics/2.1-ocean-gate-blog-post.png" alt="OceanGate Blogpost" style="width:600px;" class="fragment" />
</span>
