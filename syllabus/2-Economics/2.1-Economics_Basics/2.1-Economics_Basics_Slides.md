...
- **Law of supply**: Keeping other factors constant: If the price of a good increases, the quantity supplied also increases (because suppliers can make more profit!).
...
- Demand & supply model forces in markets and con be used to estimate equilibrium quantity/price.
...
- Typically, economists distinguish between three market forms.
  ...
  - Oligopoly: Not so many firms, many consumers.
...
- Under perfect competition ...
  - ... there are so many firms that a single firm's production quantity, does not affect the price, in the market.
  - ... the marginal costs ("the cost of one additional unit") of the production quantity equals the market price.
  - ... firms have 0 profit.
...
- The monopolist is therefore sole price-setter and serves only to maximize their own profits.

This leads to sub-optimal (higher than necessary) pricing, leading overall welfare to be lowered among consumers either through starvation of consumer resources (a "monopolist tax", in the case of inelastic demand) or through market-exclusion of would-be participants (in the case of elastic demand).
...
- Because of the competition between firms,
  - prices are lower,
  - overall market participation is higher (in the case of elastic demand then for this market, otherwise, for other markets where the consumer might otherwise spend).
...
- So, your opportunity cost of watching a soccer game is 400$ (supposing the game incl. break and overtime takes 2h).
...
- For a long time economic theory was built on the assumption that their actors were rational.
  - No other-regarding (or social) preferences like fairness, altruism, inequality aversion.
...
- Daniel Kahnemann, a psychologist, received the 2002 Nobel Prize for Prospect Theory, a fundamental theory in Behavioral Economics.
...
- Overconfidence: If asked, more than 50% of people think they drive above average.
  ...
  Sometimes overconfident people are better than others statistically perform better in practice.
