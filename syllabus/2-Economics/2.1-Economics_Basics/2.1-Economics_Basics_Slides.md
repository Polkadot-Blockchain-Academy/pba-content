...
Notes:
- It is also important to understand the limits of these economic concepts and when they might not work as intented.
...
<li class="fragment">Sensitivity of quantity demanded or supplied to changes in price.</li>
    ...
    <li class="fragment">Low elasticity: price changes do not affect quantity demanded or supplied.</li>
    </ul>
</ul>
...
Notes:
- Confirmation bias especially pronounced in todays time where people get trapped in echochambers fostered by algorithms that keep feeding you information that you want to hear.
