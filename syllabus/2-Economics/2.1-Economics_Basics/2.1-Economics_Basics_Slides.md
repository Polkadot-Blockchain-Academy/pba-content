...
- In the blockchain space we know scarcity maybe more than anywhere else: Blockspace is a very valuable good.
...
<img src="../../../assets/img/2-Economics/rr-giphy.webp" alt="Demand Schedule" style="width:700px;"/>
...
- Statistical guarantees\* about _machines_
- Objective
...
- Statistical implications about _humans_
- Subjective
- Social norms & incentives drive behavior
...
Cryptography sets **hard bounds** on what is possible to do.
Mathematically rigorous systems of & assertions about information.
In the context of human abuse of systems to reason about information, it can only go so far.

Econ has few guarantees, but sets **soft, subjective, bounds** that cryptography cannot.


Crypto & Econ pair well!
Many of the properties that we desire in Web3 emerge from using both together, where the other is lacking.
Crypto doesn't forbid some scenarios that we want to prevent, but econ may render them practically impossible because of the irrational and unfavorable outcomes of such behavior.
Example: nuclear deterrence. It is _possible_ to nuke anyone, anytime, but it doesn't happen because the cost to you and everyone is so high.
...
- We assume convexity because of decreasing returns of scale (in a world of scarcity firms cannot forever increase their demand for goods without affecting price)
...
- Give students time to think about the problem and solve it.
- Next slides will provide a step-by-step solution.

---

## Solution: Perfect Competition

- We saw before that under perfect competition the firm does not have influence on the price and will set it to marginal costs.
- Then we can derive how much the firm produces, the quantity q. <!-- .element: class="fragment" -->
  - $p = 13,000 - q$ <!-- .element: class="fragment" -->
  - $1,000 = 13,000 - q$ <!-- .element: class="fragment" -->
  - $q = 12,000$ -> The firm produces 12,000 diamonds <!-- .element: class="fragment" -->
- Profit? <!-- .element: class="fragment" -->
  - $\pi = p(q) * q - c(q) * q$ <!-- .element: class="fragment" -->
  - $\pi = 1,000 * 12,000 - 1,000 * 12,000 = 0$ -> Firms under perfect competition do not make a profit. Why? <!-- .element: class="fragment" -->
...
- We learned before that marginal costs equal marginal revenue for monopolists.
- Revenue is: $r = P(q)*q$ -> $r = (13,000-q)*q$ <!-- .element: class="fragment" -->
- The marginal revenue (how much does the firm earn when it sells one additional unit): <!-- .element: class="fragment" -->
  - $\frac{\delta r}{\delta q} = 13,000 - 2q$ <!-- .element: class="fragment" -->
  - $1,000 = 13,000 - 2q$ <!-- .element: class="fragment" -->
  - $q = 6,000$ -> The firm produces 6,000 diamonds <!-- .element: class="fragment" -->
- How about profit? <!-- .element: class="fragment" -->
  - $\pi = P(q) * q - c(q)$ <!-- .element: class="fragment" -->
  - $\pi = (13,000 - 6,000)*6,000 - 6,000 * 1,000$ <!-- .element: class="fragment" -->
  - -> $36,000,000,000 (!)<!-- .element: class="fragment" -->
...
- Table with production under specialization: 3kg and 2kg for Alice, 0kg 16/3kg for Bob.
- Sum of production in specialization.
...
- Question: What are your personal opportunity costs of sitting here?
...
- This is especially important to notice when collaborating in a team.
- Despite having somebody the absolute advantage in many domains, it might still be good to specialize and delegate tasks
...
#### **https://otree.w3f.tech/room/academy_wallet** <!-- markdown-link-check-disable-line --> <!-- TODO Insert new production links to academy games -->
...
**https://otree.w3f.tech/room/academy_ultimatum** <!-- markdown-link-check-disable-line --> <!-- TODO Insert new production links to academy games -->
...
#### **https://otree.w3f.tech/room/academy_cournot** <!-- markdown-link-check-disable-line --> <!-- TODO Insert new production links to academy games -->
