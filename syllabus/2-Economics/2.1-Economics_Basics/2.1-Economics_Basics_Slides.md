...
- Subjective behavior
- Incentive systems & Social norms
...
Already covered Cryptography in this course.
Mathmatically rigorous was to 

Econ is "fuzzier", there are few guarantees, but .

Crypto & Econ are quite good at reinforcing eachother, as may of the properties that we desire are covered well by one where the other is lacking.
