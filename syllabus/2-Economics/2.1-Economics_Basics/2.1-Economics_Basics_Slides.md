...
- Blockchain space is economics on steroids. Trustlessness mostly mean that we do not trust any humans / institutions, but we have to certainly trust that cryptography works and that economics are sound.
...
<center>
<widget-image style="width: 50vw;" src="/assets/img/2-Economics/2.1-supply-and-demand.png"></widget-image>
</center>
...
- Remark: We usually assume that it is increasing and convex, $c'(q) > 0$, $c''(q)>0$.
...
- Both are farmers that can produce meat and potatoes. <!-- .element: class="fragment" -->
- Both are time constrained; i.e., they can only produce for 8 hours per day. <!-- .element: class="fragment" -->
- Alice can produce both more meat and more potatoes per hour. <!-- .element: class="fragment" -->
...
- This works well in many circumstances (e.g., on an aggregate level or assuming highly rational actors like firms executives)... <!-- .element: class="fragment" -->
  - ... but in many it doesn't. <!-- .element: class="fragment" -->
...
- Daniel Kahnemann, a psychologist, received 2002 the Nobel Prize for Prospect Theory, a fundamental theory in Behavioral Economics. <!-- .element: class="fragment" -->
  - PT models the fact that individuals assess their losses differently than their gains. <!-- .element: class="fragment" -->


---

- IMPORTANT: Behavior is not random! <!-- .element: class="fragment" -->
- Some prominent examples are: <!-- .element: class="fragment" -->
...
- What is the purpose of the token / what utilities does it provide? <!-- .element: class="fragment" -->
- What is the token supply schedule? <!-- .element: class="fragment" -->
- What is the initial distribution of the token? <!-- .element: class="fragment" -->
- How do they want to create an economy around the token? <!-- .element: class="fragment" -->
- How do you assess their model? <!-- .element: class="fragment" -->
...
- Stablecoins are cryptocurrencies that should remain a peg towards a fiat currency. <!-- .element: class="fragment" -->
- Mostly the peg is 1:1 in USD. <!-- .element: class="fragment" -->
- This allows users to enter & exit other tokens without going through fiat, while enjoying the benefits from having a stable currency. <!-- .element: class="fragment" -->
- There are different mechanisms of how this peg is maintained. <!-- .element: class="fragment" -->
