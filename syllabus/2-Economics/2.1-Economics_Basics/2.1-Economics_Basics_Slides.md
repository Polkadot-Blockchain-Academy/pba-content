...
<img src="/assets/img/2-Economics/2.1-bitcoin-price-chart.png" alt="Bitcoin Price Chart" style="width:800px;"/>
...
> With cross-chain messaging, parachains contribute to an efficient market that proves to be beneficial for the whole Polkadot ecosystem.

* Discuss the implications of this with regard to the things learned
...
# Workshop 
- TODO: remove this slide in live version
- (70 min) 
...
* In 2.3, there is a big final: Use the points from your budget to bid in a classroom auction for some unique NFTs.
...
TODO: More detailed for every chapter or general like this? 
...
* Dump all important articles / resources that we didn't go through.
