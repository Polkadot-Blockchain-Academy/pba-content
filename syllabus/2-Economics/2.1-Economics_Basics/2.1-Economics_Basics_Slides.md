...
- Provides tools how to make actions secure.
...
- Provides tools to understand which actions are taken (and why).
...
- This is _not_ the argument here. Here, monopolies are bad because they prevent potential buyers from buying _at all._ <!-- .element: class="fragment" -->
