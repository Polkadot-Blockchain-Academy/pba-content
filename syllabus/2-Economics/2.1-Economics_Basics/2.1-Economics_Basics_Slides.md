...
- Size of consumer base <!-- .element: class="fragment" -->
- Average disposable income of consumer base <!-- .element: class="fragment" -->
- Price of substitution goods <!-- .element: class="fragment" -->
- Preferences prevalent within consumer base <!-- .element: class="fragment" -->
- Expectations prevalent within consumer base <!-- .element: class="fragment" -->
...
- Demand & supply model forces in markets and con be used to estimate equilibrium quantity/price. <!-- .element: class="fragment" -->
...
- Typically, economists distinguish between three market forms. <!-- .element: class="fragment" -->
  ...
  - Oligopoly: Not so many firms, many consumers. <!-- .element: class="fragment" -->
...
- Perfect Competition: <!-- .element: class="fragment" -->
  - Consumer products with low barrier to entry (e.g., kebab stand in Berlin 🥙🙈, espresso bar in Italy ☕️🙈) <!-- .element: class="fragment" -->
...
Monopolies are bad because there are unrealized gains from trade! <!-- .element: class="fragment" -->

- Often monopolies are deemed to be bad because they charge high prices to existing customers and that is seen as unfair. <!-- .element: class="fragment" -->
- This is not the economic argument against monopolies.
  ...
  If the price were lower, then the monopoly could serve more customers. <!-- .element: class="fragment" -->
- Prices merely constitute a transfer.
  But transfers do not matter for the utilitarian who wants to maximize total welfare. <!-- .element: class="fragment" -->
...
- For a long time economic theory was built on the assumption that their actors were rational. <!-- .element: class="fragment" -->
  - No other-regarding (or social) preferences like fairness, altruism, inequality aversion. <!-- .element: class="fragment" -->
...
- Influenced by psychological aspects such as emotions, cognition as well as cultural and societal factors. <!-- .element: class="fragment" -->
...
#### _Behavior is not random!_ <!-- .element: class="fragment" -->
...
- Gambler's Fallacy: In many situations probabilities of repeated events are independent from each other.
  Often decision makers fail to understand this. <!-- .element: class="fragment" -->
