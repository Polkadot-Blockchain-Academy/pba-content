...
* The important thing is that revenues is *concave*.
...
* The _firm_ (auctioneer) asks the _buyers_ (bidders) to submit bids, then allocates the item to one of them accordingly. The winner's payment is also a function of the bids.
