...
So, let's start here. I'm going to assert that coordinated activity is the basis of so much human behavior.  
...
less trust, more truth <!-- .element: class="fragment" data-fragment-index="1" -->
