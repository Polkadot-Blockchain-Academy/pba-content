...
- Potentially show some encoding/decoding (SCALE) that is critical for debugging/troubleshooting latter
- How it is configured on a specific chain, with the universal location
- Canonical representation of multilocation (i guess canonical by default)
...
- Re-anchoring when messages land on new consensus systems
