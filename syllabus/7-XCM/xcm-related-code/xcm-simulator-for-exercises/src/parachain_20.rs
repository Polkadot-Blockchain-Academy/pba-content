...
use xcm_builder::{
	AccountKey20Aliases, AllowUnpaidExecutionFrom, CurrencyAdapter as XcmCurrencyAdapter,
	EnsureXcmOrigin, FixedWeightBounds, FixedRateOfFungible, IsConcrete, LocationInverter,
	NativeAsset, SignedAccountKey20AsNative,
};
...
use frame_support::traits::{OriginTrait, Get};
...
impl<
	...
	> Convert<RuntimeOrigin, MultiLocation> for SignedToAccountKey20<RuntimeOrigin, AccountId, Network>
where
