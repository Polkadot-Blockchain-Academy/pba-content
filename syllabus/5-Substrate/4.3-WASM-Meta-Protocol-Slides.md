...
- Please clone `substrate` now, and run `cargo build && cargo build --release`.
...
<img style="width: 1200px;" src="../../assets/img/5-Substrate/dev-4-3-author-pool.svg" />
<div class="fragment fade-out" style="width: 200px; height: 100px; position: fixed; left: 470px; bottom: 200px; background: #140526"></div>
<div class="fragment fade-out" style="width: 200px; height: 75px; position: fixed; left: 470px; bottom: 200px; background: #140526"></div>
<div class="fragment fade-out" style="width: 200px; height: 50px; position: fixed; left: 470px; bottom: 200px; background: #140526"></div>
<div class="fragment fade-out" style="width: 200px; height: 25px; position: fixed; left: 470px; bottom: 200px; background: #140526"></div>
...
<img style="width: 1200px;" src="../../assets/img/5-Substrate/dev-4-3-author-builder.svg" />

<!-- This is the box that will hide items of the tx-pool -->
<div style="
...
<!-- This is the box that will put items in the block. -->
...
TODO update this with transitions.
...
- Take good note of the trust relationship the tx-pool, the block builder and the block importer.
...
be sure. If it fails, then you have to continue. For example, the pool might validate a nonce that
becomes invalid. Or a fee payment.
...
all of these need a coordinated fork-full update, I'm afraid.
...
### Haunting APIs and Host Functions
...
```rust
runtime.initialize_block(real_header);
runtime.execute_block(block);
```
...
- Oblivious client.
- Metadata
- Consideration: speed, breaking host functions, panic.
