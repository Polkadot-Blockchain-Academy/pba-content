...
- What use is that, i we cannot agree on what to replace/upgrade?
<!-- .element: class="fragment" -->
- Governance!
<!-- .element: class="fragment" -->
...
- The fixed meta-protocol of any any substrate based chain?
<!-- .element: class="fragment" -->
- "State machine encoded as Wasm".
<!-- .element: class="fragment" -->
- Upgradable Protocol of any substrate based chain?
<!-- .element: class="fragment" -->
- "Whatever is encoded in that Wasm".
<!-- .element: class="fragment" -->
...
<img style="width: 1200px" src="../../assets/img/5-Substrate/dev-4-1-state-database.svg" />
...
- Interacting with Substrate (60m)
