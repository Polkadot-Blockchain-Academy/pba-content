...
TODO: question from bruno:

1. state pruning is a purely client optimization. The runtime doesn't see it.
2. And importantly, the runtime only, ALWAYS sees the state associated with its own block.
