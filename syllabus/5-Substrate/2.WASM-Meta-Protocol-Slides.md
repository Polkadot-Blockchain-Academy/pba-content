...
TODO: diagram of the entire block building and importing would be good.
...
<img style="width: 1200px;" src="../../assets/img/5-Substrate/todo.png" />
...
* While authoring a block, validator will not tolerate this. <!-- .element: class="fragment" -->
