...
* Try and find places where in the client code, we call into a specific API.
...
* Try and find the places where in `frame`/runtime code, we call into a specific host function.
...
TODO: figure of the Polkadot release page+Telemetry+PJS API.
