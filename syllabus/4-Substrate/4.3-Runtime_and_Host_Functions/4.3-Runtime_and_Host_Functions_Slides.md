...
<widget-speaker small name="Kian Paimani" position="Writes Code."
image="/assets/img/0-Shared/people/kian.png"></widget-speaker>
...
<image src="/assets/img/4-Substrate/4.3_runtime_host_-1.svg" style="height: 550px"></image>

---v

###  Substrate

<image src="/assets/img/4-Substrate/4.3_runtime_host_0.svg" style="height: 550px"></image>

---v

###  Substrate

<image src="/assets/img/4-Substrate/4.3_runtime_host_1.svg" style="height: 550px"></image>
...
<image src="/assets/img/4-Substrate/4.3-code_update_0.svg" style="height:600px">
...
<image src="/assets/img/4-Substrate/4.3-code_update_1.svg" style="height:600px">

---v

### Runtime Upgrades

<image src="/assets/img/4-Substrate/4.3-code_update_2.svg" style="height:600px">

---v

### Runtime Upgrades

<image src="/assets/img/4-Substrate/4.3-code_update_3.svg" style="height:600px">
...
<img src="/assets/img/4-Substrate/4.3_runtime_host_full.svg" style="height:600px"></img>

---v

### Example: Block Execution

<img src="/assets/img/4-Substrate/4.3-block_exec_0.svg" style="height:600px">

---v

### Example: Block Execution

<img src="/assets/img/4-Substrate/4.3-block_exec_1.svg" style="height:600px">

---v

### Example: Block Execution

<img src="/assets/img/4-Substrate/4.3-block_exec_2.svg" style="height:600px">

---v

### Example: Block Execution

<img src="/assets/img/4-Substrate/4.3-block_exec_3.svg" style="height:600px">
...
<img src="/assets/img/4-Substrate/4.3_runtime_host_full_native.svg" style="height:500px"></img>
...
..but it has a **slow ono-time delay**.
...
The old one must stay FOREVER! 😱, and the new one added.
...
TLDR; Less complicated, less frequently needed, supports versioning too.
