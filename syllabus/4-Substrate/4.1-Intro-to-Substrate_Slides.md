...
<img rounded width="1000px" src="../../assets/img/4-Substrate/dev-4-1-substrate-website.gif"></img>
...
<img rounded width="900px" src="../../assets/img/4-Substrate/dev-4-1-speed.png"></img>
...
- Emphasize more: SMALDOT is not the *substrate client itself compiled to wasm*, it is another
