...
flowchart TD
  A["A <br> Hash(B|C)"] --> B["B <br> Hash(B|E)"]
  A --> C["C <br> Hash(F) <br>"]
  B --> D["D <br> value: 0x12"]
  B --> E["E <br> value: 0x23"]
  C --> F["F <br> value: 0x34"]
...
%%{init: {'theme': 'dark', 'themeVariables': { 'darkMode': true }}}%%
flowchart TD
  A["A <br> Hash(B|C)"] -- a --> B["B <br> Hash(B|E)"]
  A --b--> C["C <br> Hash(F) <br>"]
  B --c--> D["D <br> value: 0x12"]
  B --d--> E["E <br> value: 0x23"]
  C --e--> F["F <br> value: 0x34"]
</diagram>
