...
<img style="width: 1400px;" src="../../assets/img/4-Substrate/trie-backend-simple-simple.svg" />
...
Note from emeric: the green node is not really a "real" node, it is just `{ value: BIG_STUFF }` stored in the database. I will skip this detail for the sake of simplicity. One can assume that the green node is like any other node in the trie.
...
- Done right, the tree should be balanced because of FRAME's proper hashing.
...
<img style="width: 1400px;" src="../../assets/img/4-Substrate/dev-4-3-pruning-3.svg" />
---v
...
<pba-col>
<img src="../../assets/img/4-Substrate/dev-storage-full.svg" />
</pba-col>
