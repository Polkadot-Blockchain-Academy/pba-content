...
OPTIONS:
    ...
    -h, --help
        ...
        --keep-blocks <COUNT>
            ...
            Notes: only finalized blocks are subject for removal!
    ...
    -l, --log <LOG_PATTERN>...
        ...
        --tmp
            ...
            Notes: the directory is random per process execution. This directory is used as base path
...
SUBCOMMANDS:
    ...
    try-runtime
            Try some command against runtime state. Notes: `try-runtime` feature must be enabled
    vanity
