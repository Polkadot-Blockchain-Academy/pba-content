...
- We create a gadget to perform BFT agreement on top of an already existing blockchain
  - i.e. participants of the protocol will vote on what they believe is the best chain
...
<!-- TODO: add better example pictures of round flow -->
...
Note: I might create a slide for this in case the question comes up,
otherwise I'll skip it as I think it's already too much material for
a single lecture.
