...
```
wscat -c wss://rpc.polkadot.io -x '{"jsonrpc":"2.0", "id":1, "method":"system_chain" }' | jq
curl https://rpc.polkadot.io -H "Content-Type:application/json;charset=utf-8" -d   '{"jsonrpc":"2.0","id":1,"method":"system_chain"}'
