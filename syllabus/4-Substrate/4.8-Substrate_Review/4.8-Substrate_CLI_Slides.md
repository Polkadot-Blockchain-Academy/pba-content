...
```json
{
  ...
  "bootNodes": [
    "/ip4/127.0.0.1/tcp/30333/p2p/12D3KooWNsFq6B97vcYvjtx9RTQrptYqVFN8Nvtg7Nr2fD3jBUMz"
  ],
...
You probably want to control these if you are launching multiple nodes on the same machine.
...
## Runtime Logs Disabled on Production
