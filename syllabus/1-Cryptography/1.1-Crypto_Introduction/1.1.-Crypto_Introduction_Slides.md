...
- We believe there is no easy/fast inverse of this function.
...
- Using the secret key, information can be transformed ("signed") such that anyone with knowledge of the information and the counterpart public key is able to affirm.
