...
Notes:
Cracking the old algorythms for private messages is trivial for computers.
...
There are two primary classes of ways to achive this:
...
- Asymetric crypto applied to _verify origin_.
- Wallets
