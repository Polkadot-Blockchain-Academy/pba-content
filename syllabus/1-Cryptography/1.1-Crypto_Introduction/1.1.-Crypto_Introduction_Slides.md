...
- Polkadot JS Crypto<sup>[\[4\]](https://github.com/polkadot-js/common/tree/master/packages/util-crypto)</sup> (applications)
...
\[4\] - <https://github.com/polkadot-js/common/tree/master/packages/util-crypto>
