...
As mentioned in the introduction, it's often more practical to sign the hash of a message. Therefore, the sign/verify API may look like:

- `fn sign(sk, H(msg)) -> signature;`
- `fn verify(pk, H(msg), sig) -> bool;`
