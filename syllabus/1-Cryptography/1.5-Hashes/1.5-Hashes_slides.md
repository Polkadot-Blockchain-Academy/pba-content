...
In Substrate, we often want 32-byte identifiers, but the ECDSA public key is 33 bytes. We can represent it with the hash, as verifiers can still hash the public key when verifying the signature.
