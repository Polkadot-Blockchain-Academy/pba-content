...
Actors external to a system are often represented by a public key, which can be used to store some data that the user can authorize use of by signing instructions.
...
Modules within a system can have their own information stored in other parts of the system, that they authorize use of by the module's internal logic.
