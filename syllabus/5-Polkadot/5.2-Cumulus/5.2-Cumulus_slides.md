...
<widget-speaker name="Bastian Köcher" position="Core Dev at Parity" image="/assets/img/0-Shared/people/gav.png" github="bkchr" twitter="bkchr" matrix="basti:matrix.parity.io"></widget-speaker>
