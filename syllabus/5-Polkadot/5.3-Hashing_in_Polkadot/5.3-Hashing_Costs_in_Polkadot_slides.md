...
this goes a bit out of the consideration of this lession.
...
using all values together or having a seldom read scenario: eg events events are read a lot, but not from runtime.
