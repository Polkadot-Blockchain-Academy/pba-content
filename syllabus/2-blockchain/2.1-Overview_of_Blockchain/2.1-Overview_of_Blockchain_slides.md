...
- A data structure
- Typically stores a chain of events - Incorporates a sense of time and causality
...
Problem of Consensus (with Malicious actors)
...
- consensus algorithm allows a distributed system to reach a consensus even when 
a small amount of nodes demonstrate malicious behavior
