...
<widget-speaker small name="Kian" position="Position/Department" image="/assets/img/0-Shared/people/kian.png"></widget-speaker>
...
If you change the _storage layout_, this implies a migration being needed.
...
- Same Analogy applies to `StorageMap`
