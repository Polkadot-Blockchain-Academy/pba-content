...
api.query.council.proposalOf
  ...
  .forEach(([key, value]) => console.log(`${key} // ${value}`))(
    await api.query.council.proposalOf.entries()
  )
  .forEach(([key, value]) =>
    console.log(`${key} // ${key.args[0]} // ${key.slice(-32)} // ${value}`)
  );
await api.query.council
  .proposalOf(
    "0x678debcc07e2300db98fa74979c8e75ebd0075bee8f58bf7c1ca4bda724449f8"
