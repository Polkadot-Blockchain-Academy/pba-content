...
2. "Deterministically" (immediate): Grandpa - GHOST-based Recursive ANcestor Deriving Prefix Agreement.

TODO: Any further readings on other finality gadgets?
...
*  Honest validators should answer this with a set of pre-votes or pre-commits for the second round that have a supermajority for the second block.
...
While the _client_ only runs the GRANDPA algorithm, the _runtime_ defines the rules for punishing faulty validators.
