---
title: Lesson 1 -- Economic Basics
tags: presentation
slideOptions:
  transition: 'fade'
...
# Lesson 1 -- Economic Basics (60min)
...
1. Demand & Supply: Market Equilibrium, Decreasing Marginal Utility.
2. Market Forms: Monopoly and Oligopoly vs. Perfect Competition.
3. Economics of Specialization: Comparative Advantage, Opportunity Costs, Gains from Trade.
...
* Imagine a person with the following demand for icecream
...
# 2. Market forms (Or: why monopoly bad?)
...
* The loss in welfare in a monopoly is sometimes referred to as a dead-wheight loss.

----

* In other words, monopolies are bad because there are unrealized *gains from trade*!
* Side note: 
    * Often monopolies are deemed to be bad because they charge high prices to existing customers. 
    * This is *not* the argument here. Here, monopolies are bad because they prevent potential buyers from buying *at all.*
    * Prices merely constitute a transfer. But transfers do not matter for the utilitiarian who wants to maximize total welfare.
...
# 3. The Economics of Specialization (or: why trade good?)
...
* Polkadot allows for specialized blockchains (so-called parachains) to share security and trustlessly communicate.
...
* (ALMOST) ALWAYS! The reasons are *opportunity costs* and *comparative advantages*.
...
* In autarky, 
    ...
    * Bob produces 1/6 kg of meat per hour and 2/3 kg of ptoatoes per hour.
...
* Suppose both *specialize* to some degree. 
...
* While Alice has an *absolute advantage* over Bob in both dimensions, she only has a *comparative advantage* in one.
...
* If you want to obtain a slot for your blockchain on Polkadot, you need to participate in an auction (we will discuss the particular format in Lession 3 of this module).
...
* Additional quesion: why do you think this is done this way?
...
* Before that, we give a short introduction into 
    * what *Tokenomics* means for cryptoprojects, and what it contains.
    * Some core concepts: Token inflation, intial token distribution, token utility, staking, etc.
...
* Example of an inflationary token: TBD
* Example of a deflationary token: TBD
* Example of a token with fixed supply: Bitcoin.
...
* We will hand out tokenomics papes of some existing projects.
...
* There is a focus on Supply & Demand in the IPO phase.
...
- Luna and Inflation
- Let them design a tokenomics (focusing on inflation, fees)
    - Create a problem set
- Give them a short example of an example token and ask them to discuss it
- Section about Stablecoins?
- 