...
What is the code problem we want to solve?
...
People rely on digital services every day. The are inescapable.
...
<!--
  Cryptography actually provides a lot of these guarantees, but not when an intermediary has stepped
  in between users!
-->
...
<!-- Probably a drawing to put here -->
...
<!-- Perhaps a really short pallet snippet here -->
