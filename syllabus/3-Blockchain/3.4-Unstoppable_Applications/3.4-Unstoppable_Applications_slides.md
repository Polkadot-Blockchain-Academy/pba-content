...
The executor is WebAssembly, to be as neutral as possible. The STF is part of the state and can be upgraded.
...
### Transactional vs. Free Execution
...
Smart contracts on a single chain (e.g. Ethereum) can interact trustlessly because of their shared view finality.
