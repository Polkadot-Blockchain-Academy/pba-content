...
![Consensus games on the sync/async and deterministic/probabilistic axes](../../../assets/img/3-Blockchain/3.2-FLP-impossible.png)
...
How severe are each of these offenses? Do they all warrant a slash? A full slash?
