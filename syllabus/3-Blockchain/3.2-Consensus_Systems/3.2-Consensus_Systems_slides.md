...
It is only probabalistic.

* Someone could always start mining a chain and get, with low but non-zero probability, end up with it longer.
...
Followup question: Given this weakness in Aura, Why does PArity still suggest that parachains use Aura?
Follup Answer: IDK, it doesn't make sense. This attack works just as well on a parachain as it does on any sovereign chain.
